...
FIXTURE_TRANSCRIPT = REPO_ROOT / "tests" / "fixtures" / "transcript.json"


class CLITests(unittest.TestCase):
    def setUp(self) -> None:
        self.runs_root = REPO_ROOT / "footage" / "test-runs"
    ...
    def test_help_is_portable_and_stable(self) -> None:
        ...
        self.assertFalse((REPO_ROOT / "agentic_content_system" / "handoff.py").exists())
        self.assertFalse((REPO_ROOT / "contracts" / "schemas" / "aios-handoff.schema.json").exists())
